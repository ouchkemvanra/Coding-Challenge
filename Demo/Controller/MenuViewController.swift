...
extension MenuViewController: UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            let cell = tableView.dequeueReusableCell(withIdentifier: NSStringFromClass(MenuFirstTableViewCell.self)) as! MenuFirstTableViewCell
            cell.setData()
            return cell
        default:
            let cell = tableView.dequeueReusableCell(withIdentifier: NSStringFromClass(MenuListTableViewCell.self)) as! MenuListTableViewCell
...
extension MenuViewController: UITableViewDelegate{
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
            ...
            case 1:
                ...
                case 0:
                    newViewcontroller = UINavigationController(rootViewController: HomeViewController())
                    break
                case 1:
                    newViewcontroller = UINavigationController(rootViewController: ListASpotViewController())
                case 2:
